...
module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('water_levels', [
      ...
      { id: 10, sensor_id: 'sensor01', distance_cm: 263.4, timestamp: '2025-08-03 23:08:22', createdAt: new Date(), updatedAt: new Date() },
      { id: 11, sensor_id: 'sensor01', distance_cm: 263.4, timestamp: '2025-08-03 23:08:32', createdAt: new Date(), updatedAt: new Date() },
